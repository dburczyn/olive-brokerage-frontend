...
export default function JobExt (props)
{
          ...
          <Grid item xs={12}>
            <CardActionArea>
              <CardMedia
                ...
                image={(typeof props.data.picture !== 'undefined' ? config.serverurl + props.data.picture.url : props.data.AlternatePictureUrl)}                title="Job Pic" />
            </CardActionArea>
          </Grid>
